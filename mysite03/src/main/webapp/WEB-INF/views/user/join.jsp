...
$(function(){
	...
	$("#btn-checkemail").click(function(){
		...
		$.ajax({
			url:'${ pageContext.request.contextPath }/api/user/checkemail?email=' + email,	// el이 아니구,,,jsp에서 mysite03으로 바꾸고 실행
			type: 'get',
			//contentType: 'application/json'  // post일때 바뀜
			data: '',	// post일때 바뀜
			dataType: 'json',
